...
<body>
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="juna.epizy.com"> blog</a>
    ...
    <section class="banner_part">
        ...
        <img src="../public/img/animate_icon/Ellipse_7.png" alt="" class="feature_icon_1 custom-animation1">
        <img src="../public/img/animate_icon/Ellipse_8.png" alt="" class="feature_icon_2 custom-animation2">
        <img src="../public/img/animate_icon/Ellipse_1.png" alt="" class="feature_icon_3 custom-animation3">
        <img src="../public/img/animate_icon/Ellipse_2.png" alt="" class="feature_icon_4 custom-animation4">
        <img src="../public/img/animate_icon/Ellipse_3.png" alt="" class="feature_icon_5 custom-animation5">
        <img src="../public/img/animate_icon/Ellipse_4.png" alt="" class="feature_icon_6 custom-animation6">
    </section>
    <!--::banner part start::-->
    ...
    <section class="use_sasu padding_top">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <img src="../public/img/icon/feature_icon_1.png" alt="">
                            <h4>Fully Secured</h4>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <img src="../public/img/icon/feature_icon_2.png" alt="">
                            <h4>Unique Design</h4>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            <img src="../public/img/icon/feature_icon_3.png" alt="">
                            <h4>A Volunteer</h4>
        ...
        <img src="../public/img/animate_icon/Ellipse_1.png" alt="" class="feature_icon_1 custom-animation1">
    </section>
    <!--::use sasu part end::-->
            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-6 col-lg-6">
                    <div class="learning_img">
                        <img src="../public/img/about_img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        <img src="../public/img/animate_icon/Ellipse_4.png" alt="" class="feature_icon_1 custom-animation1">
    </section>
    <!--::about_us part end::-->
    ...
    <section class="about_us right_time">
        ...
        <img src="../public/img/animate_icon/Ellipse_5.png" alt="" class="feature_icon_2 custom-animation2">
    </section>
    <!--::about_us part end::-->
    ...
    <section class="pricing_part section_padding home_page_pricing">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-3 col-sm-6">
                    <div class="single_pricing_part">
                        <img src="../public/img/icon/pricing_icon_1.png" alt="">
                        <p>Standard</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_pricing_part">
                        <img src="../public/img/icon/pricing_icon_2.png" alt="">
                        <p>Business</p>
                        <h3>$50.00 <span>/ mo</span></h3>
                        <ul>
                            <li>2GB Bandwidth</li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_pricing_part">
                        <img src="../public/img/icon/pricing_icon_3.png" alt="">
                        <p>Premium</p>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_pricing_part">
                        <img src="../public/img/icon/pricing_icon_4.png" alt="">
                        <p>Ultimate</p>
        ...
        <img src="../public/img/animate_icon/Ellipse_2.png" alt="" class="feature_icon_2 custom-animation2">
    </section>
    <!--::pricing part end::-->
    ...
    <section class="review_part padding_bottom">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-6 col-lg-6">
                    <div class="review_img">
                        <img src="../public/img/review_bg.png" alt="">
                    </div>
                </div>
                <div class="col-md-6 col-lg-5">
        ...
        <img src="../public/img/animate_icon/Ellipse_4.png" alt="" class="feature_icon_2 custom-animation2">
    </section>
    <!--::about_us part end::-->
    ...
    <section class="subscribe_part padding_bottom">
        ...
        <img src="../public/../public/img/animate_icon/Ellipse_5.png" alt="" class="feature_icon_2 custom-animation2">
    </section>
    <!--::subscribe us part end::-->
            ...
            <div class="row">
                <div class="col-sm-8 col-md-4 col-lg-4">
                    <div class="single_footer_part">
                        <a href="index.html" class="footer_logo_iner"> <img src="../public/img/footer_logo.png" alt="#"> </a>
